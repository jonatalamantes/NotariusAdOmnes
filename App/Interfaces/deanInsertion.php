<?php 
    ...
    SessionManager::validateUserInPage('deanInsertion.php');

    //Get File Contest
    $string = file_get_contents("template/DeanInsertion.html");

    //Remplace the nav
    $string = str_replace("|NavBar|", SessionManager::getNavBar(), $string);

    //Create a Button State
    $saveButton = '<button type="button" class="btn btn-success" onclick=\'validateData("deanInsertion.php", "' . SessionManager::getLastPage() . '")\'>
